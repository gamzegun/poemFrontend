...
export class UserControllerService {
     ...
     */
    public add3(body?: User, observe?: 'body', reportProgress?: boolean): Observable<ResponseModel>;
    public add3(body?: User, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<ResponseModel>>;
    public add3(body?: User, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<ResponseModel>>;
    public add3(body?: User, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
    ...
    public login(body?: Login, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<ResponseModel>('post',`${this.basePath}/restful/user/login`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
